...
| **Standing up a NEW app, or taking one LIVE** (mock answers ≠ live — the go-live checklist a setup is not complete without) | `references/models.md`, GO-LIVE CHECKLIST at the top |
